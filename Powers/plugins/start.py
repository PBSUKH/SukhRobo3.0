...
𝐂ʜᴀᴛʙꪮᴛ 𝐎ʀ 𝐌ᴏʀᴇ 𝐀ᴡᴇsꪮᴍᴇ 𝐅ᴇᴀᴛᴜʀᴇ 🥀𝐀ɴʏ 𝐇ᴇʟᴘ  🌸 𝐎𝐔𝐑 𝐓𝐄𝐀𝐌 ➪ [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/THE_DRAMA_CLUB_01)𝐕ɪsɪᴛ 𝐓ʜᴀɴᴋs 𝐅ꪮʀ 𝐔sɪɴɢ ❤️
...
async def help_menu(_, m: Message):
    if len(m.text.split()) >= 2:
        ...
        if m.chat.type == ChatType.PRIVATE:
            ...
            keyboard = ikb(ou, True)
            msg = f"""
✰ 𝐖𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐇𝐄𝐋𝐏 𝐒𝐄𝐂𝐓𝐈𝐎𝐍 ✰ ✅ 𝐂𝐥𝐢𝐜𝐤 𝐎𝐧 𝐓𝐡𝐞 🌺 𝐁𝐞𝐥𝐨𝐰 𝐁𝐮𝐭𝐭𝐨𝐧𝐬 𝐅𝐨𝐫 𝐌𝐨𝐫𝐞 𝐈𝐧𝐟𝐨𝐫𝐦𝐚𝐭𝐢𝐨𝐧 ✨ 🥀𝐈𝐟 𝐘𝐨𝐮 𝐀𝐫𝐞 𝐅𝐚𝐜𝐢𝐧𝐠 » 𝐀𝐧𝐲 𝐏𝐫𝐨𝐛𝐥𝐞𝐦𝐬 𝐢𝐧 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐓𝐡𝐞𝐧 ❥︎ 𝐘𝐨𝐮 𝐂𝐚𝐧 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐓𝐨 𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 [⎯꯭̽🇨🇦꯭꯭ ⃪Вα꯭∂ ꯭мυη∂α_꯭آآ꯭꯭꯭꯭⎯꯭ ꯭̽🌸](https://t.me/II_BAD_MUNDA_II) ❥︎ 𝐎𝐫 𝐀𝐬𝐤 𝐢𝐧 ❥︎ 𝐎𝐮𝐫 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐂𝐡𝐚𝐭 𝐆𝐫𝐨𝐮𝐩 💞 🌷𝐀𝐥𝐥 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 𝐂𝐚𝐧 𝐁𝐞 𝐔𝐬𝐞𝐝 𝐖𝐢𝐭𝐡/""""
        else:
